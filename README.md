...
2.  **A* Search (A*)**: Một thuật thuật toán tìm kiếm có thông tin, sử dụng hàm heuristic (Manhattan Distance) để ước tính chi phí từ trạng thái hiện tại đến trạng thái đích, giúp tìm kiếm đường đi tối ưu hiệu quả hơn.
